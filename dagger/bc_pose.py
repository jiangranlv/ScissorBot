...
from rl.loss_utils import HelperPointLoss, PoseLoss
...
class PointNetTransformerModule(nn.Module):
    def __init__(self, seq_len=6, input_statistics={}, pose_input_dim = 6,
        ...
        self.action_loss = PoseLoss(**action_loss_cfg, translation_unit=get_translation_std_mean(input_statistics))
    ...
    def forward_loss(self, ac_pred: torch.Tensor, ac_gt: torch.Tensor, 
        ...
        assert ac_pred.shape[1:] == (self.model_output_dim, ) and ac_gt.shape[1:] == (7, ), f"{ac_pred.shape[1:]}, {ac_gt.shape[1:]}"
